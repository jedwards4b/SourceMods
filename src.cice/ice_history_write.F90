...
! author:   Elizabeth C. Hunke, LANL
	...
	clobber=.true.)
      ...
      call ice_pio_initdecomp(iodesc=iodesc2d, pio_type=pio_real)
      call ice_pio_initdecomp(ndim3=ncat_hist, iodesc=iodesc3dc, pio_type=pio_real)
      call ice_pio_initdecomp(ndim3=nzilyr,     iodesc=iodesc3di, pio_type=pio_real)
      call ice_pio_initdecomp(ndim3=nzlyrb,    iodesc=iodesc3db, pio_type=pio_real)
      call ice_pio_initdecomp(ndim3=nverts, inner_dim=.true., iodesc=iodesc3dv, pio_type=pio_real)
      call ice_pio_initdecomp(ndim3=nzilyr,  ndim4=ncat_hist,  iodesc=iodesc4di, pio_type=pio_real)
      call ice_pio_initdecomp(ndim3=nzslyr,  ndim4=ncat_hist,  iodesc=iodesc4ds, pio_type=pio_real)
