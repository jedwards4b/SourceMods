...
!================================================================================
   ...
   subroutine ice_pio_initdecomp_2d(iodesc, pio_type)
...
!================================================================================
   ...
   subroutine ice_pio_initdecomp_3d (ndim3, iodesc, pio_type, remap)
...
!================================================================================
   ...
   subroutine ice_pio_initdecomp_3d_inner(ndim3, inner_dim, iodesc, pio_type)
      ...
      call pio_initdecomp(ice_pio_subsystem, pio_type, (/ndim3,nx_global,ny_global/), &
           dof3d, iodesc)
   ...
   subroutine ice_pio_initdecomp_4d (ndim3, ndim4, iodesc, pio_type)
      ...
      call pio_initdecomp(ice_pio_subsystem, pio_type, &
