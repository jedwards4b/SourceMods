...
!================================================================================
   ...
   subroutine io_pio_initdecomp (basetype, ndim3, kdim3, iodesc)
      ...
      integer :: pio_blocksize, pio_basesize
	 ...
	 if (ndim3 > kdim3) then
         ...
         pio_blocksize = pio_basesize*POP_nxGlobal
         do while (pio_blocksize <= min(2000000,pio_basesize*POP_nxGlobal*POP_nyGlobal))
            pio_blocksize = pio_blocksize + pio_basesize*POP_nxGlobal
         enddo
         if (my_task == master_task) then
            write(stdout, *) 'pop setting pio_blocksize = ',pio_blocksize
         endif
